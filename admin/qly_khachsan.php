...
<head>
    ...
    <title>Quản lý Khách sạn - FlyHigh Admin</title>
...
<div class="flex min-h-screen w-full">
    <aside class="flex w-64 flex-col gap-y-6 border-r border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-900">
        ...
        <nav class="flex flex-1 flex-col gap-2">
            ...
            <a class="active-nav flex items-center gap-3 rounded-lg px-3 py-2" href="qly_khachsan.php">
    ...
    <main class="flex-1 overflow-y-auto">
        ...
        <div class="p-6 md:p-10">
            ...
            <div class="mb-6 grid grid-cols-1 gap-4 rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-900/50 md:grid-cols-4">
                <div class="md:col-span-2 relative">
                    <span class="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">search</span>
                    <input class="w-full rounded-lg border-gray-300 pl-10 text-sm focus:border-primary focus:ring-primary dark:border-gray-600 dark:bg-gray-800" placeholder="Tìm tên khách sạn..."/>
                </div>
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-sm text-left">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                            <td class="px-6 py-4 font-bold text-gray-900 dark:text-white">Khách sạn Grand Saigon</td>
                            <td class="px-6 py-4 text-gray-500">Quận 1, TP.HCM</td>
                            <td class="px-6 py-4 text-gray-500">150</td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <button class="rounded p-1 text-gray-500 hover:bg-gray-100 hover:text-primary"><span class="material-symbols-outlined text-[20px]">edit</span></button>
                                    <button class="rounded p-1 text-gray-500 hover:bg-gray-100 hover:text-primary" title="Quản lý phòng"><span class="material-symbols-outlined text-[20px]">door_front</span></button>
