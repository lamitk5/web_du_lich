...
<head>
    ...
    <title>Quản lý xe - FlyHigh Admin</title>
...
<div class="flex min-h-screen w-full">
    <aside class="flex w-64 flex-col gap-y-6 border-r border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-900">
        ...
        <nav class="flex flex-1 flex-col gap-2">
            ...
            <a class="active-nav flex items-center gap-3 rounded-lg px-3 py-2" href="qly_xe.php">
    ...
    <main class="flex-1 overflow-y-auto">
        ...
        <div class="p-6 md:p-10">
            ...
            <div class="mb-6 flex flex-col gap-4 rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-900/50 md:flex-row">
                <div class="flex-1">
                    <div class="relative">
                        <span class="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">search</span>
                        <input class="w-full rounded-lg border-gray-300 pl-10 text-sm focus:border-primary focus:ring-primary dark:border-gray-600 dark:bg-gray-800" placeholder="Tìm kiếm tên xe, biển số..."/>
                    </div>
                </div>
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-sm text-left">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">VinFast VF8</td>
                            <td class="px-6 py-4 text-gray-500">VinFast Rentals</td>
                            <td class="px-6 py-4 text-gray-500">29A-123.45</td>
                            <td class="px-6 py-4">SUV</td>
                            <td class="px-6 py-4 font-semibold text-primary">1.200.000đ</td>
                            <td class="px-6 py-4">
                                <span class="inline-flex items-center rounded-full bg-green-100 px-2.5 py-0.5 text-xs font-medium text-green-700 dark:bg-green-900/30 dark:text-green-300">Sẵn có</span>
                            </td>
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <button class="rounded p-1 text-gray-500 hover:bg-gray-100 hover:text-primary dark:hover:bg-gray-800"><span class="material-symbols-outlined text-[20px]">edit</span></button>
                                    <button class="rounded p-1 text-gray-500 hover:bg-red-50 hover:text-red-600 dark:hover:bg-red-900/20"><span class="material-symbols-outlined text-[20px]">delete</span></button>
                                </div>
                            </td>
                        </tr>
                        </tbody>
            ...
            <div class="mt-4 flex items-center justify-between border-t border-gray-200 px-2 py-4 dark:border-gray-700">
                <span class="text-sm text-gray-500">Hiển thị 1-5 trên 20</span>
                <div class="flex gap-2">
                    <button class="rounded border px-3 py-1 hover:bg-gray-50 disabled:opacity-50">Trước</button>
                    <button class="rounded border px-3 py-1 hover:bg-gray-50">Sau</button>
                </div>
            </div>
        </div>
    </main>
